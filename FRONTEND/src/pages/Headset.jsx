              ...
              {filteredProducts.map((product) => (
                ...
                >
                  <div className="relative h-36">
                    <img src={product.image} alt={product.name} loading="lazy" width="400" height="144" className="w-full h-full object-cover" onError={(e) => { e.target.src = '/assets/placeholder-image.svg' }} />
